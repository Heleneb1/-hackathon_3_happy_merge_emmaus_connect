        ...
        <div className="guideBox">
          ...
          <ul>
            <div className="listContainer">
              ...
              <li>
                Après avoir entré vos identifiants (adresse mail + mot de
                passe), vous êtes automatiquement redirigé vers une page avec un
                formulaire.
              </li>{" "}
            </div>
            <div className="listContainer">
            ...
            <div className="listContainer">
              ...
              <li>
                En en-tête du site, vous avez également la possibilité de
                modifier les valeurs d'indices qui permettent de calculer le
                prix du téléphone, au cas où celles-ci viendraient à changer.
              </li>
            </div>
          </ul>
        </div>
